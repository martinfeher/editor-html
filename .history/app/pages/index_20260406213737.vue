  ...
  <div class="editor-root">
    ...
    <aside class="sidebar" aria-label="Tools and properties">
      ...
      <section class="block-list" aria-label="Layers">
        ...
        <p class="stack-hint">Top = in front on the card; bottom = behind. Matches the canvas stack.</p>
        <ul>
          <li v-for="{ block: b } in layersFrontFirst" :key="b.id">
            <button
              type="button"
              class="layer-btn"
    ...
    <main class="canvas-wrap">
      ...
      <p class="hint">
        ...
        <kbd class="kbd">Ctrl</kbd> or         <kbd class="kbd">⌘</kbd> + scroll to zoom. Layer lists put the front of the card at the top.
      </p>
    </main>
    ...
    <aside class="sidebar-right" aria-label="Layer stack">
      ...
      <section class="right-section" aria-label="Stack order">
        ...
        <p v-if="blocks.length === 0" class="empty-hint">No layers yet.</p>
      </section>
    </aside>
  </div>
</template>
